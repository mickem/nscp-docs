...
<dl>
  <dt>Correct selection :  : </dt>
  <dd>
    <p># check_drivesize "perf-config=used.used(unit:G;suffix:'') used %(ignored:true)"</p>
    <p>render_perf remove-perf command=check_drivesize arguments "perf-config=used.used(unit:G;suffix:'') used %(ignored:true)"</p>
    <p>OK: OK:</p>
    <p>C:\    213.593 G      178.777 201.124 223.471 0</p>
    <p>, D:\   400.8   G       372.607 419.183 465.759 0</p>
    <p>, E:\   0       G       0       0       0       0</p>
  </dd>
</dl>
