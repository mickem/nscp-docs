...
| [is template](#/settings/system/windows/counters/default_is template) | 0 | IS TEMPLATE|
...
| [is template](#/settings/system/windows/counters/sample_is template) | 0 | IS TEMPLATE|
